...
/// Newtype wrapper for [`Regex`] enabling serde deserialization and hashing by pattern.
#[serde_as]
...
mod tests {
    ...
    fn regex_cfg_hashes_by_pattern() {
        ...
        let regex = RegexCfg::deserialize(StrDeserializer::<DeError>::new("foo")).expect("regex");
