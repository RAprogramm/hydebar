...
fn nord_has_correct_background() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(46, 52, 64))
    );
}
...
fn gruvbox_dark_has_correct_background() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(40, 40, 40))
    );
}
...
fn gruvbox_light_has_correct_background() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(251, 241, 199))
    );
}
...
fn catppuccin_macchiato_colors() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(36, 39, 58))
    );
    assert_eq!(
        appearance.text_color,
        AppearanceColor::Simple(HexColor::rgb(202, 211, 245))
    );
}
...
fn catppuccin_frappe_colors() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(48, 52, 70))
    );
    assert_eq!(
        appearance.text_color,
        AppearanceColor::Simple(HexColor::rgb(198, 208, 245))
    );
}
...
fn catppuccin_latte_colors() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(239, 241, 245))
    );
    assert_eq!(
        appearance.text_color,
        AppearanceColor::Simple(HexColor::rgb(76, 79, 105))
    );
}
...
fn tokyo_night_storm_colors() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(36, 40, 59))
    );
}
...
fn tokyo_night_light_colors() {
    ...
    assert_eq!(
        appearance.background_color,
        AppearanceColor::Simple(HexColor::rgb(213, 214, 219))
    );
}
