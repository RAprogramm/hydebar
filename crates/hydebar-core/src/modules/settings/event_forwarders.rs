...
impl ServiceEventPublisher<AudioService,> for AudioEventForwarder
{
    ...
    {
        if let Err(err,) = self.sender.try_send(Message::Audio(AudioMessage::Event(event,),),) {
...
impl ServiceEventPublisher<BrightnessService,> for BrightnessEventForwarder
{
    ...
    {
        if let Err(err,) =
            self.sender.try_send(Message::Brightness(BrightnessMessage::Event(event,),),)
        {
...
impl ServiceEventPublisher<NetworkService,> for NetworkEventForwarder
{
    ...
    {
        if let Err(err,) = self.sender.try_send(Message::Network(NetworkMessage::Event(event,),),)
        {
...
impl ServiceEventPublisher<BluetoothService,> for BluetoothEventForwarder
{
    ...
    {
        if let Err(err,) =
            self.sender.try_send(Message::Bluetooth(BluetoothMessage::Event(event,),),)
        {
...
impl ServiceEventPublisher<UPowerService,> for UPowerEventForwarder
{
    ...
    {
        if let Err(err,) = self.sender.try_send(Message::UPower(UPowerMessage::Event(event,),),) {
