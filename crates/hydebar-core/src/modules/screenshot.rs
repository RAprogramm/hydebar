...
impl Screenshot
{
            ...
            ScreenshotAction::Area => {
                ...
                match slurp_output {
                    Ok(output,) if output.status.success() => {
                        ...
                        Command::new("grim",).arg("-g",).arg(geometry,).arg(&filename,).spawn()
                    }
                    Ok(_,) => {
    ...
    pub fn stop_recording(&mut self,)
    {
        ...
        match Command::new("pkill",).arg("-SIGINT",).arg("wf-recorder",).spawn() {
            Ok(_,) => {
    ...
    pub fn menu_view(&self, _opacity: f32,) -> Element<ScreenshotMessage,>
    {
        ...
        let screenshot_buttons = Column::new()
            ...
            .push(
                ...
                .on_press(ScreenshotMessage::TakeScreenshot(ScreenshotAction::Fullscreen,),)
                .width(iced::Length::Fill,),
            )
            .spacing(4,);
    ...
    M: 'static + Clone + From<ScreenshotMessage,>,
{
    ...
    ) -> Option<(Element<'static, M,>, Option<OnModulePress<M,>,>,),>
    {
        ...
        Some(
            (container(content,).into(), Some(OnModulePress::ToggleMenu(MenuType::Screenshot,),),),
        )
    }
}
