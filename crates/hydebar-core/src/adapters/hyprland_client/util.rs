...
pub(crate) mod tests
{
    ...
    {
        assert_eq!(calculate_retry_delay(Duration::from_millis(50), 0), Duration::ZERO);
        assert_eq!(calculate_retry_delay(Duration::from_millis(50), 1), Duration::from_millis(50));
        assert_eq!(
